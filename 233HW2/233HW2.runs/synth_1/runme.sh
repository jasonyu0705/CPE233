...
HD_PWD='C:/Users/jason/233HW2/233HW2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PC_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PC_TOP.tcl
